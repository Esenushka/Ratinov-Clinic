...
function App() {
  return (
    <>
      <div className="adaptiveBlockForMB">
        <h1>
          Мобильная Версия В Разработке Откройте сайт на Персонольном Компютере
          Или перейдите в инстаграм
        </h1>
        <a
          href="https://www.instagram.com/doctor_ratinov/"
          rel="noreferrer"
          target="_blank"
          style={{ color: "blue" }}
        >
