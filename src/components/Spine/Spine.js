  ...
  return (
    <div className={scss.wrapper_bg}>
      ...
      <div className={"container " + scss.wrapper}>
        <h1>
          Как проходит лечение грыж <span>без операции</span>
        </h1>
        ...
        <div className={scss.des}>
          ...
          <p>
            {infoList.map((info) => (
              <span key={info.id}>
                {info.title} {info.duration ? <dd> + </dd> : ""}
              </span>
            ))}
          </p>
          <p>
            Набор процедур может отличаться в зависимости от индивидуальных
            особенностей заболевания.
          </p>
          <p>
            <b>Возможные дополнительные процедуры: </b>
            <span>Ударно-волновая терапия + массаж</span>, которые могут
            назначаться лечащими врачом после осмотра, анамнеза заболевания,
            доп. анализов (МРТ, анализ крови). Больше информации вы сможете
            получить на очном приеме у врача.
          </p>
          <p>
