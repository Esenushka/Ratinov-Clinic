...
import ModalWorker from "./HeaderModal";
...
const Header = ({ isResult, setHeader, isHeader }) => {
  ...
  const onOpenModalWorker = () => {
    setWorker(!isWorker);
  };

  return (
    <>
      <ModalWorker isOpen={isWorker} setOpen={setWorker} />
          ...
          <div className="container">
            <div className={styles.headerBottom}>
              ...
              <div className={styles.headerBottomRight}>
                ...
                {/* // */}
                <p onClick={() => onOpenModalWorker()} className={styles.link}>
                  Предложение для госслужащих
                </p>
