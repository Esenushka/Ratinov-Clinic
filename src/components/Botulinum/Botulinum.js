...
export default memo(function Botulinum() {
  const [botox, setBotox] = useState(true);
  const [deagnoz, setDeagnoz] = useState(true);
  return (
    <>
      ...
      <div className={scss.wrapepr}>
        <div className={scss.block}>
          <div className="container">
            <h1 onClick={() => setBotox(!botox)}>Что лечит ботокс?</h1>
            {botox && (
              <ul>
                <li>
                  Спастичность(двигательное нарушение, причиной которого
                  является повышенный тонус мышц)
                </li>
                <li>Хроническая боль </li>
                <li>
                  Различные головные боли(мигрень, боль напряжения,
                  цервикогенная боль)
                </li>
          ...
          <div className="container">
            ...
            {botox && (
              <ul>
                ...
                <li>
                  Количество единиц назначается индивидуально после очного
                  приёма врача.
                </li>
              </ul>
            )}
        ...
        <div className={scss.bottom}>
          ...
          <div className={scss.first}>
            <div className="container">
              <h1 onClick={() => setDeagnoz(!deagnoz)}>Диагностика </h1>
              {deagnoz && (
                <p>
          ...
          <div className={scss.second}>
            <div className="container">
              <h1 onClick={() => setDeagnoz(!deagnoz)}>Лечение</h1>
              {deagnoz && (
                <p>
